...
const FunFace = () => {
  ...
  // Since this is a SSR page, 'window' is not defined on server, only defined on Browser/Client side.

  // Check to run this script only on Client Side/Browser
        ...
        <div className="funfacebody">
          ...
          <div className="eye-outer">
            ...
            <div className="left-eye">
              <svg className="funFace" viewBox="0 0 21 21">
